...
*/}
        <li>
          <NavLink
            to="/home"
            className={({ isActive }) =>
              `block px-2 py-2 rounded hover:bg-gray-700 transition flex items-center gap-2 ${
...
*/}
        ...
        <li>
          <NavLink
            ...
            className={({ isActive }) =>
              `flex  justify-between w-full rounded hover:bg-gray-700 transition flex items-center gap-}`
            }
          >
            ...
            <ul className="ml-4 mt-1 space-y-1 text-sm">
              ...
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex  justify-between w-full rounded hover:bg-gray-700 transition flex items-center gap-2 `
                  }
                >
                  <div className="flex gap-2 items-center px-2 py-2">
          ...
          {openMenus["Administration"] && (
            <ul className="ml-4 mt-1 space-y-1 text-sm">
              ...
              <li>
                ...
                >
                  <div className="flex gap-2 items-center px-2 py-2">
                    <span>Consultas de cliente</span>
                  </div>
                </NavLink>
              </li>
            </ul>
        ...
        <li>
          ...
          {openMenus["Logistics"] && (
            <ul className="ml-4 mt-1 space-y-1 text-sm">
              ...
              <li>
                <NavLink
                  to="logistics/inventary"
                  className={({ isActive }) =>
                    `justify-between w-full rounded hover:bg-gray-700 transition flex items-center gap-2 `
                  }
                >
                  <div className="flex gap-2 items-center px-2 py-2">
                    <span>Registrar inventarios</span>
                  </div>
                </NavLink>
              </li>
            ...
            <ul className="ml-4 mt-1 space-y-1 text-sm">
              <li>
                <a
                  ...
                  className="block px-2 py-1 rounded hover:bg-gray-700 transition flex items-center gap-2"
                >
                  <Rss size={16} />
                  <span>Blog</span>
                </a>
